...
/*
echo '<div style="direction:ltr;text-align:left;border:1px solid black; padding:5px; margin:10px; color:#000000; width:95%; margin-left:auto; margin-right:auto; font-weight:bold; font-size:95%;">TCEXAM REQUIRES A COMMERCIAL LICENSE FOR ANY COMMERCIAL USE, INCLUDING WHEN A NON-PROFIT ORGANIZATION IS ASKING ANY FEE TO ITS MEMBERS/USERS, YOU MUST CONTACT <a href="mailto:info@tecnick.com" title="mail to tecnick.com">info@tecnick.com</a> TO PURCHASE A LICENSE.</div>'.K_NEWLINE;

echo '<div style="direction:ltr;text-align:left;border:1px solid black; padding:5px; margin:10px; color:#000000; width:95%; margin-left:auto; margin-right:auto; font-weight:bold; font-size:95%;">THE FREE NON-COMMERCIAL TCEXAM LICENSE IS SUBJECT TO THE <a href="http://www.fsf.org/licensing/licenses/agpl-3.0.html" title="External link to GNU Affero General Public License">GNU-AGPL v.3 LICENSE</a> WITH ADDITIONAL RESTRICTIONS: YOU CAN\'T REMOVE, MOVE OR HIDE THE ORIGINAL TCEXAM LOGO, COPYRIGHTS STATEMENTS AND LINKS TO <a href="http://www.tecnick.com" title="External link to Tecnick.com">TECNICK.COM</a> AND <a href="http://www.tcexam.org" title="External link to TCExam">TCEXAM</a> WEBSITES FROM THIS SOFTWARE.<br /></div>'.K_NEWLINE;

echo '<div style="direction:ltr;text-align:left;border:1px solid black; padding:5px; margin:10px; color:#000000; width:95%; margin-left:auto; margin-right:auto; font-weight:bold; font-size:95%;">IF YOU ARE USING THE FREE VERSION PLEASE CONSIDER SUPPORTING THE TCEXAM PROJECT BY <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=NZUEC5XS8MFBJ" title="External link to make a donation for TCExam">MAKING A DONATION</a>.</div>'.K_NEWLINE;
*/
// Display test limits (if any)
echo "<div style='clear:both;with:100%; height:20px;'></div>";
$limits = '';
...
//echo "<div style='height:200px;width:200px; background-color:red;'></div>";
